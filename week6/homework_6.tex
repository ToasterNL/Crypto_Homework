...
We can expand this for all $n$ as follows:
...
More generally, we can always construct a number $n = x^{n-1} + \frac{1}{x}$ so that $nx = x^n + 1 = 0 \pmod{x^n+1}$. We believe $\frac{1}{x}$ should then be interpreted as the multiplicative inverse of $x$ modulo $x^n+1$.
