...
To show multiplicative inverses for $x$ always exist we need to show that $gcd(x,x^n+1) = 1$, which follows from $x^n = 0 \pmod x$, so the GCD is 1 and thus an inverse exists.
