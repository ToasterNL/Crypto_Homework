...
We know that fields with prime characteristics are isomorphic to integers modulo that prime, and this information lets us reduce these middle terms all at once.
\[ = x^{p^n} + y^{p^n}~\square \]
