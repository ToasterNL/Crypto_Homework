...
This is explained wonderfully well in the original Rijndael paper in 5.2, Implementation aspects for 32-bit processor. AES has a 128-bit state block, which we can view as a 4x4-matrix of bytes.
We can express the RoundKeyAddition-step and the MixColumn-step in a series of vector/matrix multiplications:
